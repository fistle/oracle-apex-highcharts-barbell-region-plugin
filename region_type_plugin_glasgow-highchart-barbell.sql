...
--   Application:     144
--   Name:            APEX plugins
--   Date and Time:   12:50 Wednesday August 24, 2022
--   Exported By:     DAVID
--   Flashback:       0
--   Export Type:     Component Export
--   Manifest
--     PLUGIN: 21746149602229763
--   Manifest End
--   Version:         22.1.2
...
/
prompt --application/shared_components/plugins/region_type/glasgow_highchart_barbell
begin
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(21746149602229763)
,p_plugin_type=>'REGION TYPE'
,p_name=>'GLASGOW-HIGHCHART-BARBELL'
,p_display_name=>' highchart-barbell'
,p_supported_ui_types=>'DESKTOP'
,p_plsql_code=>wwv_flow_string.join(wwv_flow_t_varchar2(
'----------------------------------------------------------------------------------',
'--',
'-- Renders a highCharts barbell chart using data returned from the SQL query.',
'--',
...
'    chartSubName VARCHAR(100) := nvl(p_region.attribute_02, '''');   ',
'    showCredits VARCHAR(100) := nvl(p_region.attribute_03, ''true'');',
'    yAxisName VARCHAR(100) := nvl(p_region.attribute_04, '''');',
'    seriesName VARCHAR(100) := nvl(p_region.attribute_05, '''');',
'    ',
'begin',
...
'HTP.p (''<script src="https://code.highcharts.com/modules/dumbbell.js"></script>'');',
...
'    HTP.p (''    result.push({'');',
'    HTP.p (''        name: ''''''|| query_result(1)(rowNumber) || '''''',',
'                    low: ''|| query_result(2)(rowNumber) || '',',
'                    high: ''|| query_result(3)(rowNumber) || ''});'');',
'end loop;',
'',
'HTP.p (''return result;'');',
'HTP.p (''}'');',
...
,p_about_url=>'https://kjwvivmv0n5reuj-apexkqor.adb.uk-london-1.oraclecloudapps.com/ords/r/test1/apex-plugins/highchart-dumbbell'
,p_files_version=>24
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21746359990229763)
,p_plugin_id=>wwv_flow_imp.id(21746149602229763)
...
,p_help_text=>'Will appear on the top of the chart and will also appear in the tooltips.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21746743911229764)
,p_plugin_id=>wwv_flow_imp.id(21746149602229763)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>2
,p_display_sequence=>20
,p_prompt=>'Chart sub name'
,p_attribute_type=>'TEXT'
,p_is_required=>false
,p_is_translatable=>false
,p_examples=>'Info source: <a href="https://en.wikipedia.org/wiki/Timeline_of_space_exploration">www.wikipedia.org</a>'
,p_help_text=>'Sub title of the timeline'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21747189503229764)
,p_plugin_id=>wwv_flow_imp.id(21746149602229763)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>3
,p_display_sequence=>30
,p_prompt=>'Show credits'
,p_attribute_type=>'TEXT'
,p_is_required=>false
,p_default_value=>'true'
,p_is_translatable=>false
,p_examples=>'true or false'
,p_help_text=>'Highchart by default puts a credits label in the lower right corner of the chart.  This can be removed by setting this to false.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(21752270529290699)
,p_plugin_id=>wwv_flow_imp.id(21746149602229763)
,p_attribute_scope=>'COMPONENT'
,p_attribute_sequence=>4
,p_display_sequence=>40
,p_prompt=>'Y Axis name'
,p_attribute_type=>'TEXT'
,p_is_required=>false
,p_is_translatable=>false
);
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(21747804041229768)
,p_plugin_id=>wwv_flow_imp.id(21746149602229763)
